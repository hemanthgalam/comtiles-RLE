...
const pyramidIndexEntries = await comtReader.readPyramidIndex(metadataByteLength, metadata.tileOffsetBytes);
const fragmentIndexEntries = await comtReader.readPyramidIndex(metadataByteLength, metadata.tileOffsetBytes);
