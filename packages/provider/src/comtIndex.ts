...
export default class ComtIndex {
    ...
    private calculateSparseFragmentBounds(
        ...
        return this.calculateFragmentBounds(x, y, limit, fragmentBoundsOfSpecifiedTileGlobalTilCrs);
    }

    private calculateFragmentBounds(x, y, tileSetLimits: TileMatrixLimits, denseFragmentLimits: TileMatrixLimits) {
        if (x == null && y == null) {
            /*  calculateDenseFragmentBounds */
            return denseFragmentLimits;
        } else {
